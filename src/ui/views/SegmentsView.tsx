...
import { Panel, FieldLabel, TextInput } from "../components";
...
export function SegmentsView({ world, saveSegment, deleteSegment, setFocus }: {
  world: World;
    ...
    <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
      <Panel title="Build a Segment" style={{ flex: "1 1 380px" }}>
        ...
        <button style={{ ...bigBtn, width: "100%", marginTop: 12, opacity: name.trim() && draftStats.cellCount > 0 ? 1 : .5 }}
          ...
          onClick={() => { saveSegment(name, filter); setName(""); setFilter({}); }}>
          Save segment
        </button>
      </Panel>
